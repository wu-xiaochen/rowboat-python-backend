    ...
    async def initialize(self):
        ...
        try:
            ...
            self.embeddings = OpenAIEmbeddings(
                ...
                openai_api_key=settings.embedding_api_key or settings.provider_api_key,  # 使用专门的 embedding_api_key
...
async def create_rag_tool(collection_name: str, description: str = "Search knowledge base") -> Any:
    ...
    class RAGTool:
        ...
        def _run(self, query: str) -> str:
            ...
            try:
                ...
                results = loop.run_until_complete(
                    rag_manager.search(self.collection_name, query, k=3)
                )

                return rag_manager.format_search_results(results)
        ...
        async def _arun(self, query: str) -> str:
            ...
            try:
                results = await rag_manager.search(self.collection_name, query, k=3)
                return rag_manager.format_search_results(results)

            except Exception as e:
                return f"Error searching knowledge base: {str(e)}"

    return RAGTool(collection_name, description)
